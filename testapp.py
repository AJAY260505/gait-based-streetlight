...
while True:
    ...
    # text on panel
    cv2.putText(frame_resized, panel_text, (panel_x + 20, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,255,255), 2)
    cv2.putText(frame_resized, f"Sound:{sound}   AssistButton:{accessibility_mode}", (panel_x + 20, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2)
